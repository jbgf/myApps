                   ...
                   <div class="container1200">
                     ...
                     <div class="s_container bg-white">
                         ...
                         <form class="solution_form  clear">
                             <div class="form-row relative height-auto">
                                 <div class="un-block-1 align-right mediumSize">
                                     <span>企业名称：</span>
                                 </div>
                                 <div class="un-block-2">
                                 <input class="baseInput" placeholder="请填写您的企业名称" name="cname" type="text" required></input>
                             ...
                             <div class="form-row ">
                                 ...
                                 <div class="un-block-2">
                                    <input class="baseInput" placeholder="请填写联系人" name="license" type="text"  required></input>
                             ...
                             <div class="form-row ">
                                 ...
                                 <div class="un-block-2">
                                    <input class="baseInput" placeholder="请填写联系方式" name="license" type="text"  required></input>
                             ...
                             <div class="form-row height-auto">
                                 ...
                                 <div class="un-block-2">
                                 <textarea class="baseInput mediumSize" placeholder="" name="ainfo" type="text" ></textarea>
                                 </div>
