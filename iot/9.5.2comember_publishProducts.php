                     ...
                     <div class="s_container bg-white">
                         ...
                         <form class="solution_form clear">
                             <div class="form-row height-auto">
                                 ...
                                 <input class="baseInput" placeholder="请输入痛点名称" name="cname" type="text" required></input>
                             ...
                             <div class="form-row height-auto">
                                 ...
                                 <div class="un-block-3">
                                     <div class="p_thumb picker relative cursor">
                                         
                                     </div>
                                     <div class="p_thumb picker relative cursor"></div>
                                     <div class="p_thumb picker relative cursor"></div>
                                     <div class="p_thumb picker relative cursor"></div>
                             ...
                             <div class="form-row height-auto">
                                 ...
                                 <div class="un-block-2">
                                    <input class="baseInput" placeholder="请输入品牌" name="license" type="text"  required></input>
                             ...
                             <div class="form-row height-auto">
                                 ...
                                 <div class="un-block-2">
                                    <input class="baseInput" placeholder="请输入型号" name="license" type="text"  required></input>
                             ...
                             <div class="form-row height-auto">
                                 ...
                                 <div class="un-block-2">
                                    <input class="baseInput" placeholder="请输入用途" name="license" type="text"  required></input>
