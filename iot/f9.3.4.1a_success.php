                     ...
                     <div class="p_container bg-white">
                         <div class="process_show mar-center">
                             <ul class="rows ">
                                 ...
                                 <li class="row-block-4">
                                    <div class="innerBlock i2 white align-center">
                                        认证审核
                                    </div>
                                 </li>
                                 <li class="row-block-4">
                                    <div class="innerBlock i3 white align-center"> <!-- class=i3 white-->
                                        审核结果
                                    </div>
                                 </li>
                             </ul>
                         ...
                         <div class="">
                               <div class="container1200 align-center">
                                    <div id="a_box">
                                        <div class="tips ">
                                            <img src="img/icon42.jpg">
                                            <div class="bigt orange">审核通过</div>
                                            <p class="smallSize gray">恭喜您，完成创客认证</p>
                                        </div>
                                        <div class="btnrow iBlock mediumSize">
                                            <a href="" class="signBtn bg-orange i_white">发布痛点</a>
                                            <a href="" id="return" class=" signBtn i_gray">返回首页</a>
                                        </div> 
                                    </div>
