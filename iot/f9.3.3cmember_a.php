                     ...
                     <div class="p_container bg-white">
                         <div class="process_show mar-center">
                             <ul class="rows ">
                                 ...
                                 <li class="row-block-4">
                                    <div class="innerBlock  align-center"> <!-- class=i3 white-->
                                        审核结果
                                    </div>
                                 </li>
                             </ul>
                         ...
                         <div class="">
                               <div class="container1200 align-center">
                                    <div class="tips " style="padding-bottom:100px;">
                                        <img src="img/icon44.png">
                                        <p class="bigSize " style="padding:20px 0 10px;">您提交的认证将在3日内反馈</p>
                                        <p class="gray smallSize">认证期间，您的个人资料将不能做更改</p>
                                    </div>
