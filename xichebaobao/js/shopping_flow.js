...
function check_before_submit(){
    ...
    if(checkOrderForm(the_form)){
		...
		document.getElementById("btn-submit").style.background = "#dddddd";
		document.getElementById("btn-submit").value = '处理中，请稍候。。。';
		submit_the_form();
