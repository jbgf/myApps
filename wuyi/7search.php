  ...
  <div class="leftSideBarWrapper">
    ...
    <div class="leftSideBarWrapper-right">
         <div class="header08 clear">
              <span class="h-title01">在线留言</span>
              <div class="more float-r">你的位置：<a>网站首页</a> > <a>在线留言</a> </div>
         </div>
         <div class="lsbw-bottom">
             <style type="text/css">
               .green{color:#00732f;font-weight: bold;}
             </style>
             <div style="padding: 35px 0 15px;margin-bottom:30px;font-size: 15.6px;border-bottom: 1px dashed #ddd;">
               您正在搜索的“标准”，共找到<span class="green">4</span>条结果
             </div>

             <div class="list07 list">
                <ul>
                    <li><a><span class="date">【2017-09-04】</span><span class="text">2014年度上海<span class="green">标准</span>务贸易发展专项资金申 </span>  </a></li>
             ...
             <div class="pagination02" data-type="pagination">
                  ...
                  <div class="info float-l">共6页,177条记录</div> 
             </div>
             </div>
         </div>
    </div>
