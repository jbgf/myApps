...
function brandWall (allData){
	...
	this.birdSpeed = allData.birdSpeed || 10;
	this.canvasheight = wh/4;
	this.wrapper = $(allData.birdWrapper);
    this.birdmp3 = allData.birdmp3;
...
brandWall.prototype.birds = function(options){
	...
	function showBrand(data){            /*success喜鹊投掷商标之后展示到相应的位置*/
		...
		WeixinJSBridge.invoke('getNetworkType', {}, function(e) {
                ...
                audioEngine.playEffect(that.birdmp3, false);    
        });
		that.isComplete();
