<?php include './head.html' ?> <!-- 抽奖页面 -->
    <div class="pageWrapper">
   
            
                <!-- 背景 start -->
                <div class="a_bg"><img src="img/mainBg2.jpg" alt="bg"></div>
                <!-- 背景 end -->
                ...
                <div class="pageMain">
                    ...
                    <div class="show-qr daqiao lg-button1 yellowBg">
                        ...
                        <div class="text">
                            <div class="center">搭桥成功，点击领奖</div>
                        </div></a>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var bridge = new sprite(boptions);

        $(".bridge-box").addClass("fadeIn")
