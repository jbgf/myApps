...
(function(a){ 
    ...
    a.initEdit = function(d) {
        ...
        function i(w, t, v) { 
            $$("#uploadBg").fadeIn(200);
            $$("#uploadImgBox").css("left", $$(".editDetail").offset().left + 12)
                               .removeClass("uploadUp").addClass("uploadDown");
            var x = $$("#uploadInfoBox");
        ...
        $(function() { 
            ...
            if (!_manage) { $(".gameBgBox .soundIcon").css("z-index", "100");
                ...
                $("#startBtnImg,.startBtnImg").on("touchend", function(l) {
                    ...
                    if (typeof hg.sound.cache[0] !== "undefined" 
    ...
    (function() { 
        a.logStd = c(40, function(d, g) {
            ...
            $.ajax({ 
                ...
                data: { msg: "hgLog-" + d + " msg=" + g + " aid=" + g_config.aid + " gameId=" + g_config.gameId + " openId=" + g_config.openId }, 
            }) 
        });
        a.logErr = c(3, function(d, e) { 
            $.ajax({ type: "post", 
                     url: g_config.ajaxUrl + "logJsErr_h.jsp?cmd=jsLogErr", 
                     data: { msg: "hgErr-" + d + " msg=" + e + " aid=" + g_config.aid + " gameId=" + g_config.gameId + " openId=" + g_config.openId }, 
                 }) 
        });
   ...
   /* a.logDogSynch = function(f, d, e) {
    ...
    a.initComment = function(c) { $.extend(a.bulletparam, c) } 
})(HdGame);
