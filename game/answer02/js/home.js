...
/*！！！！！！！*/			/*黑板高度*/
			$("#a_bg8").height(function(i,h){
						return wh*.65;
			}).attr({"display":"block"}).css({"width":"100%"});

/*！！！！！！！*/			/*答题按钮位置*/
			$("#start_answer").css({"bottom":wh*.2,"position":"relative"})

			$(".page").not($(".page").first()).addClass("hide")
		
		var modal = $(".homePoupMask02");
/*！！！！！！！*/			/*规则页面*/
			$("#rule_details").css({"height":wh*.9,'width':ww*.9}).parents("#skillSupPoup").css({"height":wh*.9,'width':ww*.9})
...
/*！！！！！！！*/
				...
				var that = this;
                    ...
                    /*第几次答题*********************/ 
                    	...
                    	var flag = determine(points),
                    		...
                    		resultUrl = flag?'goodresult.html' : 'badresult.html';              	
		...
		countDown:function(){
	                 ...
	                 var timer = setInterval(function(){
	                    ...
	                    if(timeCount-i<=final_time){$(".clock").addClass("shake")}
...
var result = {
	...
	ini:function(_options){
		...
		jQuery(".tips").slide({mainCell:".bd ul",autoPlay:true,effect:"topLoop",vis:1,interTime:1500});
