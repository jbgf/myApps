(function($)
{
    ...
    ScratchPad.prototype = 
    {
        generate: function()
        {
            ...
            this.sp =
            $('<div></div>')
            .addClass(this.settings.spClass)
        ...
        init: function()
        {
            ...
            var parwidth,parheight;
                parwidth =  $(this.sp).width();
                parheight = $(this.sp).height();
            this.canvas.width = parwidth;
            this.canvas.height = parheight;
