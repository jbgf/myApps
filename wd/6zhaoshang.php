<?php include 'head.html' ?>
       ...
       <div class="banner1" style="background:url(img/banner1.jpg) center center no-repeat">
       </div>
       <div class="container1150">
            <div class="planRow">
                <div class="header06">
                    <div class="hborder">
                      <div class="h-title01 ">代理商扶持计划</div>
                    </div>
                    <div class="sub-title">
                        企业根据自身需求可自定义开发功能模块
                    </div>
                ...
                <ul class="prUl">
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl1.png) center center no-repeat">
                          
                          <div class="top">
                            客户资源
                          </div>
                          <div class="bottom">
                            总部会根据代理商在一线市场的反馈,经评估后给予相关产品支持,促进代理商的销售工作。专属合作伙伴拓展经理提供业务支持和商务支持，帮助您在电子商务领域取得成功。  
                          </div>
                      </div>
                    </div>
                  </li>
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl2.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl3.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl4.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl5.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl6.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl7.png) center center no-repeat">
                  ...
                  <li class="row-block">
                    <div class="inner">
                      <div class="plBlock" style="background:url(img/pl8.png) center center no-repeat">
                    ...
                    <div class="form4">
                        <form >
                            <div class="formInner active">                 
                               ...
                               <div class="form-row">
                                  <div class="zprow-block-2">
                                     <div class="un-block-1 align-right mediumSize">
                                         <span>公司名称</span>
                                     </div>
                                     <div class="un-block-2">
                                     <input class="baseInput" placeholder="* 请正确填写您的真实公司名称" name="identify" type="text" required="" aria-required="true"></div>
                                  </div>
                                  <div class="zprow-block-2 align-right">
                                     <div class="halfWrapper">
                                         <div class="un-block-1 align-right mediumSize">
                                             <span>姓名</span>
                                         </div>
                                         <div class="un-block-2">
                                         <input class="baseInput" placeholder="* 请正确填写您的真实姓名" name="identify" type="text" ></div>
                                     </div>
                                  </div>
                               </div>
                               <div class="form-row">
                                   ...
                                   <div class="un-block-3">
                                        <input class="baseInput" placeholder="* 请正确填写您的手机号" name="identify" type="text" >
                                   </div>
                               ...
                               <div class="form-row height-auto">
                                   ...
                                   <div class="un-block-3">
                                       <textarea class="baseInput"></textarea>
                                   </div>
                                   
                               </div>
                                <div class="align-center">
                                   <button type="submit" class="roundBtn02">
                                    提交申请
                                   </button>
                                </div>
       ...
       <div class="">
          <div class="container1150">
            <div class="iconGroup02  align-center">
